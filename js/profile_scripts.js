...
$('.icn-edit').click(function(){
    $('#oneliner-wrapper').addClass('edit-mode');
    $('.icn-edit').addClass('d-none');
    $('.bioupdate').removeClass('d-none');
    $('.buttons-wrapper').addClass('d-none');
});
$('#cancel').click(function(event){
    event.preventDefault();
    $('#oneliner-wrapper').removeClass('edit-mode');
    $('.icn-edit').removeClass('d-none');
    $('.bioupdate').addClass('d-none');
    $('.buttons-wrapper').removeClass('d-none');
});

$('#editDescription').click(function (){
    $('#editDescription').addClass('d-none');
    $('#descriptionForm').removeClass('d-none');
    $('#descriptionData').addClass('d-none');
})
$('.cancel').click(function (){
    $('#editDescription').removeClass('d-none');
    $('#descriptionForm').addClass('d-none');
    $('#descriptionData').removeClass('d-none');
})

$('#langNew').click(function (){
    $('#LangForm').removeClass('d-none');
    $('#langData').addClass('d-none');
})

$('#langForm #cancel').click(function (event){
    event.preventDefault();
    $('#LangForm').addClass('d-none');
    $('#langData').removeClass('d-none');
})

$('#skillAdd').click(function (){
    $('#skillData').addClass('d-none');
    $('#skillform').removeClass('d-none');
});

$('#skillCancel').click(function (event){
    event.preventDefault();
    $('#skillData').removeClass('d-none');
    $('#skillform').addClass('d-none');
})

$('#addEducation').click(function (){
    $('#educationList').addClass('d-none');
    $('#addEducation').addClass('d-none');
    $('#educationform').removeClass('d-none');
})

$('#cancleEducation').click(function (event){
    event.preventDefault();
    $('#educationList').removeClass('d-none');
    $('#addEducation').removeClass('d-none');
    $('#educationform').addClass('d-none');
})
...
function autocomplete(inp, arr) {
    ...
    function addActive(x) {
        ...
        x[currentFocus].classList.add("autocomplete-list");
    }
