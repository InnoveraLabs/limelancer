            ...
            <div class="col-md-12 px-5">
                <article class="db-new-content js-db-cont">
                    ...
                    <header class="order-header mb-4">
                        ...
                        <h1 class="header-title">Manage Sales</h1>
                    </header>
                    ...
                    <div class="manage-orders">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a href="#priority-orders" data-toggle="tab" class="nav-link active">Priority</a></li>
                            <li class="nav-item"><a href="#new-orders" data-toggle="tab" class="nav-link">New</a></li>
                            <li class="nav-item"><a href="#active-orders" data-toggle="tab" class="nav-link">Active</a></li>
                            <li class="nav-item"><a href="#late-orders" data-toggle="tab" class="nav-link">Late</a></li>
                    ...
                    <div class="tab-content orders-tab-content">
                        <div id="priority-orders" class="container tab-pane active show"><br>
                        ...
                        <div id="active-orders" class="container tab-pane fade"><br>
                            <table class="orders-table">
                                <thead>
