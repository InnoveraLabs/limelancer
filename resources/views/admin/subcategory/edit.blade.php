                        ...
                        <div class="col-lg-4">
                            <div class="page-header float-left">
                                <div class="page-title">
                                    <h1><i class="menu-icon fa fa-bars"></i> Update Sub-Category </h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.subcategories.update', $subCategory->id) }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="sub_c_name" class="form-control" value="{{ $subCategory->sub_c_name }}">
                                    </div>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-md-6">
										<input type="hidden"  name="sub_c_home" value="0" >
										<input type="checkbox"  name="sub_c_home" value='1' <?php if ($subCategory->sub_c_home==1){echo 'Checked';}?>>
                                    </div>
                                </div>
